...
const uint8 dbx001D[] =
{
    0x23, 0x06, 0x16, 0x23, 0x00, 0x19, 0xF7, 0x4B, 0x00, 0x23, 0xF0,
    0x02, 0xF0, 0x5E, 0x00, 0x23, 0xF0, 0x24, 0xFB, 0x23, 0x00, 0xFF
};

const uint8 dbx004B[] =
{
    0x23, 0xF0, 0x26, 0x23, 0x14,
    0x13, 0xFE, 0x0D, 0x0B, 0x0A, 0x08, 0x06, 0x04, 0x03, 0x01, 0x23,
    0xFF, 0xFF, 0xFF, 0x44, 0xE4,
    0x18, 0xFB, 0x44, 0x00, 0xFF, 0xFF, 0xC9
};

const uint8 dbx0067[] =
{
    0x23, 0x08, 0x08, 0x23,
    0x03, 0x1B, 0x23, 0x08, 0x0F, 0x23, 0x16, 0x15, 0xF7, 0x84, 0x00, 0x23, 0x16, 0x03, 0xF0, 0x97,
    0x00, 0x23, 0x16, 0x19, 0xFB, 0x23, 0x00, 0xFF, 0xFF, 0x23, 0x16, 0x01, 0xFE, 0x0D, 0x0C, 0x0A,
    0x08, 0x06, 0x04, 0x03, 0x01, 0x23, 0xFC, 0x30, 0x23, 0x00, 0xFF, 0xFF, 0x44, 0x27, 0x0E, 0xFB,
    0x44, 0x00, 0xFF, 0xFF
};
...
const uint8 dbx009F[] =
{
    ...
    0xF0, 0xCC, 0x00, 0x23, 0xF0, 0x20, 0xFB, 0x23, 0x00, 0xFF, 0xFF, 0x23, 0xF0, 0x20, 0x23, 0x10,
    0x0D, 0xFE, 0x1A, 0x18, 0x15, 0x10, 0x0C, 0x08, 0x05, 0x03, 0x23, 0xFE, 0x30, 0x23, 0x00, 0xFF,
    0xFF, 0x33, 0xE0, 0x10, 0xFB, 0x44, 0x00, 0xFF, 0xFF
};

const uint8 dbx00D4[] =
{
    0x23, 0x03, 0x18, 0x33, 0x04, 0x10, 0x23,
    0x08, 0x0A, 0x44, 0x16, 0x12, 0xF7, 0x60, 0x01, 0x44, 0x16, 0x03, 0xF0, 0x73, 0x01, 0x44, 0x16,
    0x1D, 0xFB, 0x23, 0x00, 0xFF, 0xFF, 0x12, 0x18, 0x17, 0x12, 0x00, 0x80, 0xFF, 0xFF, 0xFF, 0xFF,
...
const uint8 d_0160[] =
{
    ...
    0x00, 0xff, 0xff, 0x66, 0x20, 0x14, 0xfb, 0x44, 0x00, 0xff, 0xff
};

const uint8 dbx017B[] =
{
    0x23, 0x06, 0x18, 0x23, 0x00,
...
const uint8 dbx01B0[] =
{
    ...
    0xe0, 0x01, 0x23, 0x16, 0x1d, 0xfb, 0x23, 0x00, 0xff, 0xff,
    0x23, 0x16, 0x01, 0xfe, 0x0d, 0x0c, 0x0b, 0x09, 0x07, 0x05, 0x03, 0x02, 0x23, 0x02, 0x20, 0x23,
    0xfc, 0x12, 0x23, 0x00, 0xff, 0xff, 0x44, 0x20, 0x14, 0xfb, 0x44, 0x00, 0xff, 0xff
};
...
const uint8 dbx01F5[] =
{
    0x23, 0x02, 0x3a, 0x23, 0x10, 0x09, 0x23, 0x00, 0x18, 0x23, 0x20,
    0x10, 0x23, 0x00, 0x18, 0x23, 0x20, 0x0d, 0x23, 0x00, 0xff, 0xff
};
...
const uint8 dbx022B[] =
{
    0x23, 0x00, 0x28, 0x23, 0x06, 0x1d, 0x23, 0x00, 0x11, 0x00, 0x40, 0x08, 0x23, 0x00, 0x11, 0x23,
    0xfa, 0x1d, 0x23, 0x00, 0x50, 0xff
};
...
const uint8 dbx025D[] =
{
    0x23, 0x00, 0x08, 0x00, 0x20, 0x08, 0x23, 0xf0, 0x20, 0x23, 0x10, 0x20, 0x23, 0xf0, 0x40, 0x23,
    0x10, 0x20, 0x23, 0xf0, 0x20, 0x00, 0x20, 0x08, 0x23, 0x00, 0x30, 0xff
};

const uint8 dbx0279[] =
{
    0x23, 0x10, 0x0c, 0x23, 0x00, 0x20, 0x23,
    0xe8, 0x10, 0x23, 0xf4, 0x10, 0x23, 0xe8, 0x10, 0x23, 0xf4, 0x32, 0x23, 0xe8, 0x10, 0x23, 0xf4,
    0x32, 0x23, 0xe8, 0x10, 0x23, 0xf4, 0x10, 0x23, 0xe8, 0x0e, 0x23, 0x02, 0x30, 0xff
};

const uint8 dbx029E[] =
{
    0x23, 0xf1, 0x08, 0x23, 0x00, 0x10, 0x23, 0x05, 0x3c, 0x23, 0x07, 0x42, 0x23, 0x0a, 0x40, 0x23,
    0x10, 0x2d, 0x23, 0x20, 0x19, 0x00, 0xfc, 0x14, 0x23, 0x02, 0x4a, 0xff
};

const uint8 dbx02BA[] =
{
    0x23, 0x04, 0x20, 0x23, 0x00, 0x16, 0x23, 0xf0, 0x30, 0x23, 0x00, 0x12, 0x23, 0x10, 0x30, 0x23,
    0x00, 0x12, 0x23, 0x10, 0x30, 0x23, 0x00, 0x16, 0x23, 0x04, 0x20, 0x23, 0x00, 0x10, 0xff
};

const uint8 dbx02D9[] =
{
    0x23, 0x00, 0x15, 0x00, 0x20, 0x08, 0x23,
    0x00, 0x11, 0x00, 0xe0, 0x08, 0x23, 0x00, 0x18, 0x00, 0x20, 0x08, 0x23, 0x00, 0x13, 0x00, 0xe0,
    0x08, 0x23, 0x00, 0x1f, 0x00, 0x20, 0x08, 0x23, 0x00, 0x30, 0xff
};

const uint8 dbx02FB[] =
{
    0x23, 0x02, 0x0e, 0x23, 0x00,
...
const uint8 dbx031D[] =
{
    0x23, 0x00, 0x0d, 0x00, 0xc0, 0x04, 0x23, 0x00, 0x21, 0x00, 0x40, 0x06, 0x23, 0x00, 0x51, 0x00,
    0xc0, 0x06, 0x23, 0x00, 0x73, 0xff
};

const uint8 dbx0333[] =
{
    0x23,0x08,0x20,0x23,0x00,0x16,0x23,0xe0,0x0c,0x23,0x02,0x0b,0x23,
    0x11,0x0c,0x23,0x02,0x0b,0x23,0xe0,0x0c,0x23,0x00,0x16,0x23,0x08,0x20,0xff
};
...
const uint8 dbx034F[] =
{
    ...
    0x10,0x12,0x00,0x40,0xfb,0x12,0x00,0xff,0xff
};

const uint8 dbx03A9[] =
{
    0x12,0x18,0x1d,0x12,0x00,0x28,0x12,
...
#endif
    {
                ...
                b8800_obj_status[ L ].state == 9))
        {
            ...
            if (0 == ds_bug_motion_que[b_bug_que_idx].b0D)
            {
                ...
                // ld   l,0x08(ix)
                // ld   h,0x09(ix)
                pHLdata = ds_bug_motion_que[b_bug_que_idx].p08;
                ...
                do
                {
                    ...
                    if (A_token >= 0xEF) // ... else ...  jp   c,l_0BDC_flite_pth_load
                    {
                        ...
                        case 0x03: // _0B4E: //  bee dive and starting loopback, or boss left position and starting dive down
                            pHLdata++; // inc  hl
                            ds_bug_motion_que[b_bug_que_idx].b06 = *pHLdata;
                            pHLdata++; // inc  hl
                        ...
                        case 0x06: // _0B5F: //  bee has flown under bottom of screen and now turns for home
                            ...
                            // l_0B8C:
                            ds_bug_motion_que[b_bug_que_idx].p08 = pHLdata;
                        ...
                        case 0x08: // _0B98: //  attack wave
                            ...
                            {
                                // jp   z,l_0B46  ; jp if this is a "transient" ($38, $3A, $3C, $3E)
                                //l_0B46:
                                //       inc  hl
                                //       ld   e,(hl)
                                //       inc  hl
                ...
                {
                    ds_bug_motion_que[b_bug_que_idx].b0C = -(*pHLdata); // neg
                }
                else
                {
                    //l_0BF7
                    ds_bug_motion_que[b_bug_que_idx].b0C = *pHLdata;
                }

                pHLdata++;

                ds_bug_motion_que[b_bug_que_idx].b0D = *pHLdata;
